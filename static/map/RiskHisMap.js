webpackJsonp([0], {
    153 : function(e, t, a) {
        ...
        function o(e, t) {
            var a = s.init(e);
            return n.series[0].data = t.sort(function(e, t) {
        ...
        function l(e, t) {
            t && (n.series[0].data = t.sort(function(e, t) {
                return e.value - t.value
            }), e.setOption(n, !0)),
            e.resize()
        }
    ...
    154 : function(e, t, a) {
        ...
        default)("<li>成功欺诈额/成功交易额</li>").attr("class", 7 === x ? "selected": "").appendTo(k),
            ...
            default)(e.target).addClass("selected"), C.forEach(function(e) {
                    e.css("display", "none")
                }), C[0].css("display", "block"), b.val("报警量"), x = 0) : "欺诈笔数" === (0, m.
            default)(e.target).text() ? ((0, m.
            default)(e.target).parent().children(".selected").removeClass("selected"), (0, m.
            default)(e.target).addClass("selected"), C.forEach(function(e) {
                    e.css("display", "none")
                }), C[1].css("display", "block"), b.val("欺诈笔数"), x = 1) : "欺诈金额（万元）" === (0, m.
            default)(e.target).text() ? ((0, m.
            default)(e.target).parent().children(".selected").removeClass("selected"), (0, m.
            default)(e.target).addClass("selected"), C.forEach(function(e) {
                    e.css("display", "none")
                }), C[2].css("display", "block"), b.val("欺诈金额（万元）"), x = 2) : "请求笔数" === (0, m.
            default)(e.target).text() ? ((0, m.
            default)(e.target).parent().children(".selected").removeClass("selected"), (0, m.
            default)(e.target).addClass("selected"), C.forEach(function(e) {
                    e.css("display", "none")
                }), C[3].css("display", "block"), b.val("请求笔数"), x = 3) : "请求金额（万元）" === (0, m.
            default)(e.target).text() ? ((0, m.
            default)(e.target).parent().children(".selected").removeClass("selected"), (0, m.
            default)(e.target).addClass("selected"), C.forEach(function(e) {
                    e.css("display", "none")
                }), C[4].css("display", "block"), b.val("请求金额（万元）"), x = 4) : "交易笔数" === (0, m.
            default)(e.target).text() ? ((0, m.
            default)(e.target).parent().children(".selected").removeClass("selected"), (0, m.
            default)(e.target).addClass("selected"), C.forEach(function(e) {
                    e.css("display", "none")
                }), C[5].css("display", "block"), b.val("交易笔数"), x = 5) : "交易金额（万元）" === (0, m.
            default)(e.target).text() ? ((0, m.
            default)(e.target).parent().children(".selected").removeClass("selected"), (0, m.
            default)(e.target).addClass("selected"), C.forEach(function(e) {
                    e.css("display", "none")
                }), C[6].css("display", "block"), b.val("交易金额（万元）"), x = 6) : "成功欺诈额/成功交易额" === (0, m.
            default)(e.target).text() && ((0, m.
            default)(e.target).parent().children(".selected").removeClass("selected"), (0, m.
            default)(e.target).addClass("selected"), C.forEach(function(e) {
                    e.css("display", "none")
                }), C[7].css("display", "block"), b.val("成功欺诈额/成功交易额"), x = 7, _ = e),
        ...
        function l(e, t, a) {
            e.click(function() {
                var e = t.find('[style*="block"]');
                0 != e.next().length && (e.css("display", "none"), e.next().css("display", "block"), a.text(parseInt(a.text()) + 1))
            })
        }
        function s(e, t, a) {
            e.click(function() {
                var e = t.find('[style*="block"]');
                0 != e.prev().length && (e.css("display", "none"), e.prev().css("display", "block"), a.text(parseInt(a.text()) - 1))
            })
        }
        function n(e, t, a, o, l) {
            var s = Math.ceil(e.length / t),
            n = (0, m.
        default)("<div></div>").css("height", a).appendTo(o); (0, m.
        default)('<div style="display: block"></div>').appendTo(n);
            for (var d = 1; d < s; d++)(0, m.
        default)('<div style="display: none"></div>').appendTo(n);
            return e.forEach(function(e, a) {
                var o = parseInt(a / t),
                l = (0, m.
            default)('<div class="line"></div>').appendTo((0, m.
            default)(n.children()[o])); (0, m.
            default)('<span class="name">' + (a + 1) + "." + e.name + "</span>").appendTo(l); (0, m.
            default)('<span class="body"></span>').text(e.value).appendTo(l)
            }),
            r(o, s, n),
            n
        }
        function r(e, t, a) {
            var o = (0, m.
        default)('<div class="pageTurning"></div>').appendTo(e),
            n = (0, m.
        default)('<div class="upBtn"></div>').appendTo(o),
            r = (0, m.
        default)('<div class="downBtn"></div>').appendTo(o),
            d = (0, m.
        default)('<div class="inform"></div>').appendTo(o); (0, m.
        default)("<span></span>").text("第").appendTo(d);
            var i = (0, m.
        default)("<span></span>").text("1").appendTo(d); (0, m.
        default)("<span></span>").text("页，共" + (0 === t ? 1 : t) + "页").appendTo(d),
            l(r, a, i),
            s(n, a, i)
        }
        function d(e) {
    ...
    155 : function(e, t, a) {
        ...
        function o() {
            ...
            document.mozFullScreen || document.webkitFullScreen ? document.mozCancelFullScreen ? (document.mozCancelFullScreen(), document.mozFullScreen = !1) : (document.webkitCancelFullScreen(), document.webkitFullScreen = !1) : e.mozRequestFullScreen ? (e.mozRequestFullScreen(), document.mozFullScreen = !0) : (e.webkitRequestFullScreen(Element.ALLOW_KEYBOARD_INPUT), document.webkitFullScreen = !0)
        }
        Object.defineProperty(t, "__esModule", {
            value: !0
        }),
    ...
    156 : function(e, t, a) {
        "use strict";
        function o(e, t) {
            var a = echarts.init(e);
            return 0 !== t.length && (t[0].value > t[2].value || t[0].value === t[2].value) && (t[1].value > t[2].value || t[1].value === t[2].value) && (0 === t[0].value ? s.title.text = " 模型命中率：0%": s.title.text = " 模型命中率：" + Math.round(t[2].value / t[0].value * 100) + "%", s.series[0].data = t, a.setOption(s)),
            a.resize(),
            a
        }
        function l(e, t) {
            t ? 0 !== t.length && (t[0].value > t[2].value || t[0].value === t[2].value) && (t[1].value > t[2].value || t[1].value === t[2].value) ? (e.resize(), 0 === t[0].value ? s.title.text = " 模型命中率：0%": s.title.text = " 模型命中率：" + Math.round(t[2].value / t[0].value * 100) + "%", s.series[0].data = t, e.clear(), e.setOption(s, !0)) : e.clear() : (e.resize(), e.clear(), 0 !== s.series[0].data.length && e.setOption(s, !0))
        }
        Object.defineProperty(t, "__esModule", {
            value: !0
        }),
    ...
    159 : function(e, t, a) {
        ...
        t.geoCoordMap = {
            "北京": [116.405285, 40.004989],
            "安徽": [117.4, 31.7],
            "澳门": [113.54909, 22.168951],
            "甘肃": [103.212006, 35.599446],
            "福建": [119.306239, 26.375302],
            "浙江": [119.84355, 30.12],
            "重庆": [106.904962, 29.533155],
            "云南": [102.712251, 25.040609],
            "西藏": [91.132212, 29.660361],
            "新疆": [86.041075, 44.305886],
            "香港": [114.173355, 22.320048],
            "天津": [117.190182, 39.125596],
            "四川": [103.665735, 30.559462],
            "台湾": [121.509062, 25.044332],
            "山西": [108.948024, 34.063161],
            "陕西": [112.249248, 37.957014],
            "上海": [121.472644, 30.931706],
            "山东": [117.400923, 36.675807],
            "青海": [101.378916, 36.723178],
            "内蒙古": [110.340405, 41.658168],
            "宁夏": [106.278179, 38.36637],
            "辽宁": [123.229096, 42.196767],
            "吉林": [125.3245, 44.286841],
            "江西": [116.152151, 28.476493],
            "江苏": [118.767413, 31.841544],
            "湖南": [113.482279, 28.19409],
            "湖北": [114.298572, 30.384355],
            "河南": [113.665412, 34.557975],
            "黑龙江": [127.742464, 45.556967],
            "河北": [114.502461, 38.365474],
            "海南": [110.33119, 19.901971],
            "广西": [108.520004, 23.12402],
            "贵州": [106.713478, 26.878343],
            "广东": [113.580637, 23.325178]
        }
    },
    160 : function(e, t, a) {
        "use strict";
        ...
        function(n, r) {
            l = [t, a(47)],
            o = r,
            void 0 !== (s = "function" == typeof o ? o.apply(t, l) : o) && (e.exports = s)
        } (0,
        function(e, t) {
            var a = function(e) {
                "undefined" != typeof console && console && console.error && console.error(e)
            };
            return t ? t.registerMap ? void t.registerMap("china2", {
                ...
                UTF8Encoding: !0
            }) : void a("ECharts Map is not loaded") : void a("ECharts is not Loaded")
        })
    },
    161 : function(e, t, a) {
        "use strict";
        function o() {
            ...
            t = Ext.Date.format(b.getValue(), "Y-m-d");(0, d.getMapHisData)(e, t).then(function(e) {
                ...
                n = e.PROV_RANK,
                d = e.PROV_WARN_COUNT,
                f = e.PROV_CHEAT_COUNT,
                x = e.PROV_CHEAT_AMOUNT,
                b = e.PROV_TRANS_COUNT,
                T = e.PROV_TRANS_AMOUNT,
                k = e.PROV_SUC_TRANS_COUNT,
                M = e.PROV_SUC_TRANS_AMOUNT,
                O = e.PROV_CHEAT_AMOUNT_RATE; (0, r.
            default)((0, r.
            default)(".top span")[0]).text(t.WARN_COUNT),
                (0, r.
            default)((0, r.
            default)(".top span")[1]).text(t.CHEAT_COUNT),
                (0, r.
            default)((0, r.
            default)(".top span")[2]).text(t.CHEAT_AMOUNT),
                (0, r.
            default)((0, r.
            default)(".top span")[3]).text(t.TRANS_COUNT),
                (0, r.
            default)((0, r.
            default)(".top span")[4]).text(t.TRANS_AMOUNT),
                (0, r.
            default)((0, r.
            default)(".top span")[5]).text(t.SUC_TRANS_COUNT),
                (0, r.
            default)((0, r.
            default)(".top span")[6]).text(t.SUC_TRANS_AMOUNT),
                v = (0, p.drawBar)((0, r.
            default)(".bar1 .draw-bar")[0], a),
                g = (0, p.drawBar)((0, r.
            default)(".bar2 .draw-bar")[0], o),
                y = (0, u.drawVenn)((0, r.
            default)(".bar3 .draw-bar3")[0], l),
                h = (0, i.drawMap)(document.getElementById("draw-map"), n, s),
                (0, c.renderRiskRank)(m, [d, f, x, b, T, k, M, O], "his", n, s, !0)
            }),
            window.addEventListener("resize",
            function(e) {
                setTimeout(function() { (0, i.resizeMap)(h),
                    (0, p.resizeBar)(v),
                    (0, p.resizeBar)(g),
                    (0, u.resizeVenn)(y),
                    (0, c.resizeRank)("his")
        ...
        function l() {
            ...
            b = Ext.create("Ext.form.field.Date", {
                ...
                listeners: {
                    change: function(e, t, a) {
                        var o = x.getValue();
                        if (null != o && t < o) return e.setValue(a),
                        void Ext.Msg.alert("出错提示", "结束时间必须大于开始时间！");
                        var l = e.getValue();
                        if (Ext.Date.add(l, Ext.Date.MONTH, -6) > o) return e.setValue(a),
        ...
        function s() {
            ...
            t = Ext.Date.format(b.getValue(), "Y-m-d"); (0, d.getMapHisData)(e, t).then(function(e) {
                ...
                d = e.PROV_WARN_COUNT,
                f = e.PROV_CHEAT_COUNT,
                h = e.PROV_CHEAT_AMOUNT,
                x = e.PROV_TRANS_COUNT,
                b = e.PROV_TRANS_AMOUNT,
                T = e.PROV_SUC_TRANS_COUNT,
                k = e.PROV_SUC_TRANS_AMOUNT,
                M = e.PROV_CHEAT_AMOUNT_RATE; (0, r.
            default)((0, r.
            default)(".top span")[0]).text(t.WARN_COUNT),
                (0, r.
            default)((0, r.
            ...
            default)(".top span")[6]).text(t.SUC_TRANS_AMOUNT),
                ...
                (0, p.resizeBar)(g, o),
                (0, u.resizeVenn)(y, l),
                (0, i.resetMapRanking)([d, f, h, x, b, T, k, M], n, s),
                (0, c.renderRiskRank)(m, [d, f, h, x, b, T, k, M], "his", n)
            })
        }
        var n = a(38),
        r = function(e) {
    ...
    default)(".board-container"),
        ...
        setTimeout(o, 100),
        (0, r.
    default)(".map-container").dblclick(function() { (0, f.toggleFullScreen)()
        })
    },
    86 : function(e, t, a) {
        "use strict";
        function o(e, t, a, o) {
            if (t) {
                ...
                l.forEach(function(e, a) {
                    ...
                    n = 0; n < t.length; n++) if (o && o == t[n].name) {
                        t[n].value[0] = a,
                        l.value = t[n].value;
                        break
                    }
        ...
        function l(e, t) {
            e.tooltip = {
                trigger: "item",
                padding: [15],
                backgroundColor: "rgba(1,19,39,.82)",
                extraCssText: "border-radius: 4px;",
                formatter: function(e) {
                    if ("series" === e.componentType && "" != e.name) {
                        var a = e.data;
                        return '<div style="text-align: center">' + a.name + '</div><div class="clearfix"><span style="float: left;">报警量：</span><div class="MapToolTip">' + a.value[1] + '</div></div><div class="clearfix"><span style="float: left;">欺诈笔数：</span><div class="MapToolTip">' + a.value[2] + '</div></div><div class="clearfix"><span style="float: left;">欺诈金额（万元）：</span><div class="MapToolTip">' + parseFloat(a.value[3]).toFixed(2) + '</div></div><div class="clearfix"><span style="float: left;">请求笔数：</span><div class="MapToolTip">' + a.value[4] + '</div></div><div class="clearfix"><span style="float: left;">请求金额（万元）：</span><div class="MapToolTip">' + parseFloat(a.value[5]).toFixed(2) + '</div></div><div class="clearfix"><span style="float: left;">交易笔数：</span><div class="MapToolTip">' + a.value[6] + '</div></div><div class="clearfix"><span style="float: left;">交易金额（万元）：</span><div class="MapToolTip">' + parseFloat(a.value[7]).toFixed(2) + "</div></div>" + ("his" == t ? '<div class="clearfix"><span style="float: left;">成功欺诈额/成功交易额：</span><div class="MapToolTip">' + parseFloat((a.value[8] + "").replace("%", "")).toFixed(4) + "%</div></div>": "")
                    }
                }
            }
        }
        ...
        function n(e, t, a) {
            t ? (r(t), f.series[0].data = t, f.series[0].markPoint.data = u(a), e.setOption(f, !0)) : e.resize()
        }
        function r(e) {
            e && e.forEach(function(e) {
                e.value && e.value.forEach(function(t, a) {
                    var o = t,
                    l = parseFloat(o ? (o + "").replace("%", "") : o);
                    e.value[a] = 0 == l ? l.toFixed(0) : t
                })
            })
        }
        Object.defineProperty(t, "__esModule", {
        ...
        f = {
            ...
            visualMap: {
                ...
                dimension: 0,
                inRange: {
                    color: ["#00139e", "#054ae6", "#1a92f7"]
                },
                outOfRange: {
                    color: ["rgba(255, 255, 255, 0.25)", "rgba(255, 255, 255, 0.25)", "rgba(255, 255, 255, 0.25)", "rgba(255, 255, 255, 0.25)", "rgba(255, 255, 255, 0.25)"]
                },
                padding: [14, 14, 14, 14],
                itemGap: 14,
                textStyle: {
                ...
                borderColor: "#2084cf",
                borderWidth: 1,
                shadowColor: "rgba(176,235,255,.18)",
                shadowBlur: 6
            },
            series: [{
                name: "今日风险数量",
                ...
                label: {
                    normal: {
                        ...
                        formatter: function(e) {
                            return isNaN(e.value) ? "": e.data.value[p]
                        }
                    },
                    emphasis: {
                        show: !0,
