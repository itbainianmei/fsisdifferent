        ...
        <div class="dataTable clear">
            <el-table
                ...
                <template v-for="item in headList">
                    ...
                    <el-table-column :render-header="renderHeader" sortable  :width="item.width" v-if="item.prop === 'uniqueId' && item.isShow" :type="item.type" :key="item.id" :label="item.label" :prop="item.prop" align="center">
