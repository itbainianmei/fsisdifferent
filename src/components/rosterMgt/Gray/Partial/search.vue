...
export default {
        ...
        return {
            ...
            pickerEndDate: {
                disabledDate: (time) => {
                    ...
                    let s = new Date(new Date(this.searchForm.startDate).getTime() - 24*60*60*1000)
    ...
    created() {
        ...
        this.resetBtnPower = idList.indexOf(136) === -1 ? false : true;
        this.searchBtnPower = idList.indexOf(135) === -1 ? false : true;
    },
    methods: {
