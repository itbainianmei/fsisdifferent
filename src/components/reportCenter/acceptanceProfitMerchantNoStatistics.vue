...
export default {
  ...
  methods:{
    ...
    getChartData(){  //统计图
      ...
      this.$axios.post('/report/business/queryChart',qs.stringify(params)).then(res => {
