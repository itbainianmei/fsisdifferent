...
import {SPECIAL_TABLE_HEAD, KYC, COLORS, PAGESIZE_10} from '@/constants'
...
export default {
    ...
    created() {
        ...
        this.searchBtnPower = idList.indexOf(601) === -1 ? false : true;
        this.downloadBtnPower = idList.indexOf(602) === -1 ? false : true;
    ...
    methods: {
        ...
        downloadPage(){
            ...
            let url = "/report/approval/download?" + qs.stringify(sendData)
