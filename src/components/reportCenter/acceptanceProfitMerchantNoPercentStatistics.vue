    ...
    <div id="tradeandfraud" @click="allarea($event)">
        <div  class="searchBasic">
                        ...
                        <el-form ref="form" :model="form" label-width="144px" class="demo-ruleForm">
                            ...
                            <div class="formConClass">
                                <el-form-item label="结束时间:" prop="endDateStr">
                                    <el-date-picker  v-model="form.endDateStr" :picker-options="end" value-format="yyyy-MM-dd" type="date" placeholder="选择日期时间" style="width: 100%;" :clearable="false" :editable="false"></el-date-picker>
                                </el-form-item>
                            </div>
                            <div class="formConClass">
            ...
            <div class="pr" v-show="authsearch" >
              <span style="color:#f7b980;font-size:10px;position:absolute;right:7%;">友情提示:&nbsp;&nbsp;</i><i style="color:#7a8d74;font-style:normal;">柱子1: </i>交易金额占比 &nbsp; &nbsp;<i style="color:#7a8d74;font-style:normal;">柱子2: </i>毛利占比&nbsp; &nbsp;<i style="color:#7a8d74;font-style:normal;">柱子3: </i>活跃商户占比</span>
