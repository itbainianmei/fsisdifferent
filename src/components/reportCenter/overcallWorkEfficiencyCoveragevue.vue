                        ...
                        <el-form ref="form" :model="form" label-width="116px" class="demo-ruleForm">
                            ...
                            <div class="formConClass">
                                <el-form-item label="结束时间:" prop="endTime">
                                    <el-date-picker  v-model="form.endTime" value-format="yyyy-MM-dd" :picker-options="end" type="date" placeholder="选择日期时间" style="width: 60%;" :clearable="false" :editable="false"></el-date-picker>
                                </el-form-item>
                            </div>
                        </el-form>
                    </div>
