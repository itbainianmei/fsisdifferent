...
const asideRouterMap = [
  ...
  },
  {
    ...
    children:[
      ...
      {id:521,path:'/manager/CloseMerchantComplaintsSatistics',component:CloseMerchantComplaintsSatistics,name:'关闭商户数量情况',meta:['关闭商户数量情况'],act:false,hidden: true},
      ...
      {id:525,path:'/manager/MerchantInspectionCoverage',component:MerchantInspectionCoverage,name:'商户巡检情况',meta:['商户巡检情况'],act:false,hidden: true},
