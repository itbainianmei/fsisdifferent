...
export default new Router({
  routes: [
    ...
    },
    {
      ...
      children:[
        {path:'/manager/onlineMgt',component:OnlineCheckMgt,name:'线上核查单管理',meta:{keepAlive: true},act:false},
        {path:'/manager/offlineMgt',component:OfflineMgt,name:'线下核查单管理',meta:{keepAlive: true},act:false},
        {path:'/manager/config',component:ThawProConfig,name:'解冻提示配置',meta:{keepAlive: true},act:false},
        {path:'/manager/cusCheckMgt',component:CusChecklistMgt,name:'商户核查单管理平台',meta:{keepAlive: true},act:false},
        {path:'/manager/CusChecklistImmuneMgt',component:CusChecklistImmuneMgt,name:'商户核查单免疫管理',meta:{keepAlive: true},act:false},
        {path:'/manager/outCusMgt',component:OutboundCusConfigMgt,name:'外呼商户配置平台',meta:{keepAlive: true},act:false},
        {path:'/manager/mgtControl',component:ManageControlApprove,name:'管控审批清单',meta:{keepAlive: true},act:false},
        {path:'/manager/alarm',component:Alarm,name:'当天未处理报警',meta:{keepAlive: true},act:false},
...

    {
      ...
      children:[
        {path:'/manager/caseSearch',component:CaseSearch,name:"案件查询",meta:{keepAlive: true},act:false}
      ]
    },
    {
      path:'',
