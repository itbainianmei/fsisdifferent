...
export const BLOCK_TABLE_HEAD = [
    ...
    { prop: 'uniqueId', width: '190px', label: '名单值', align: 'center', slotScope: 'scope'},
    { prop: 'sourceName', width: '100px', label: '来源', align: 'center'},
    ...
    { prop: 'remarks',width: '100px', label: '备注', align: 'center'},
...
export const GRAY_TABLE_HEAD =  [
    { type: 'selection',width: '50', align: 'center',label: ''},
    { prop: 'typeName', width: '120px', align: 'center', label: '生效场景',sortable: true},
    { prop: 'tagName', align: 'center', label: '维度'},
    { prop: 'uniqueId', width: '190px', label: '名单值', align: 'center', slotScope: 'scope'},
    { prop: 'sourceName',width: '100px', label: '来源', align: 'center'},
    { prop: 'kycName', width: '130px',label: '商户KYC', align: 'center'},
    { prop: 'remark', width: '100px',label: '备注', align: 'center'},
    { prop: 'createTime', width: '170px', label: '创建日期', align: 'center'},
    { prop: 'updateTime', width: '170px', label: '更新日期', align: 'center'},
    { prop: 'updateBy', label: '操作员', width: '170px', align: 'center'}
]
...
export const COLORS = ['#c49d97','#7a8d76','#eac0ac','#8f8a7d','#faeacc','#818597','#aa8c8c','#91859c','#8f8d7e','#ea8f6a','#809668','#f7e3bf','#8ab483','#b2969c','#d0b7f5']
